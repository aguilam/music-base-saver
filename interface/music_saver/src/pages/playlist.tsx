...
import { Combobox, ComboboxContent, ComboboxControl, ComboboxInput, ComboboxItem, ComboboxItemLabel, ComboboxLabel, ComboboxPortal, ComboboxTrigger } from "~/shared/ui/combobox/combobox";
...
import { Search, SearchContent, SearchControl, SearchItem, SearchItemLabel, SearchListbox, SearchNoResult, SearchPortal } from "~/shared/ui/search/search";
      ...
      {(playlist) => (
    							      ...
    							      <DialogHeader>
    							        <DialogTitle>Change Playlist</DialogTitle>
												...
												<div class=" flex flex-col gap-2">
													...
													<Combobox<ListedUser> multiple options={users() ?? []} onChange={setPlaylistOwners} defaultValue={playlistOwners()} optionValue={"id"} optionTextValue={"username"} itemComponent={(props) => (
														<ComboboxItem item={props.item}>
															<ComboboxItemLabel>{props.item.rawValue.username}</ComboboxItemLabel>
														</ComboboxItem>
													)}>
														<ComboboxLabel>
															Playlist owners
													...
													<Button onClick={() => handleChangePlaylist(title(),null,playlistOwners().map((owner) => owner.id),isPublic())}>Save</Button>
												</div>
    							    </DialogContent>
    							  </DialogPortal>
    							</Dialog>
		...
		<div>
			<Search<ShortTrack>
    		  ...
    		  itemComponent={(props) => (
    		    <SearchItem item={props.item} onPointerDown={() => handleAddNewTrack(props.item.rawValue.id)}>
